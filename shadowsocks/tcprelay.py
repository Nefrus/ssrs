...
class TCPRelay(object):
    ...
    def __init__(self, config, dns_resolver, is_local, stat_callback=None, stat_counter=None):
        ...
        # 将 logging.info 赋值给 common.connect_log
        ...
        # 如果 协议在"auth_aes128_md5", "auth_aes128_sha1", "auth_chain_a" 这几个中
        # 更新用户表
        ...
        # 设置 stat_counter None
        self._stat_counter = stat_counter
        # 设置 _stat_callback None
            ...
            if user_list:
                ...
                for user in user_list:
                    ...
                    if len(items) == 2:
                        ...
                        # 将 user_int_id 按照特定形式转换
                        uid = struct.pack('<I', user_int_id)
                        # 若 acl 存在且 user_int_id 不存在 acl 中
